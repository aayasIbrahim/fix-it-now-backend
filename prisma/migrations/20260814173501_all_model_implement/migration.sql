/*
  ...
  - You are about to drop the `tachnician_profiles` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "tachnician_profiles" DROP CONSTRAINT "tachnician_profiles_userId_fkey";
...
-- DropTable
DROP TABLE "tachnician_profiles";
