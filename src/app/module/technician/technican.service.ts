...
import { IAvailabilitySlotPayload, IPaginationOptions, ITechnicianFilterOptions, IUpdateBookingStatusPayload, IUpdateTechnicianProfile } from './technican.interface';
